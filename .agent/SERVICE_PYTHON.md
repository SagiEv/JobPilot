...
**Role:** AI CV tailoring, Agentic workflows, heavy computation, Web Scraping (Playwright).
...
**Pipelines:** LangGraph used for defining stateful agent workflows (e.g., CV Tailoring).
